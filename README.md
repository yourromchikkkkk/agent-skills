...
- **Skills** — `/code-review`, `/github-pr-review`, `/gitlab-mr-review`, `/commit`, `/update-readme`
- **Commands** — `/code-reviewer-generator` (generates `/code-review` from team standards), `/review` (auto-routes to GitHub or GitLab review skill)
